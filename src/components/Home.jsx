  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-20">
          <article className="flex py-20 z-10">
            <div className="w-1/2 flex flex-col justify-center items-center z-10 relative">
            ...
            <div className="w-1/2 flex flex-col gap-6 justify-center z-30">
              <div>
                <h1 className="relative leading-none tracking-wide text-9xl font-black font-primary z-30">
                  R<span className={accentTextColor}>4</span>JON
                </h1>
                <h1 className="outline-title leading-none tracking-wide text-9xl font-primary -mt-28 ml-2 z-20">
                  R4JON
                </h1>
                <p className="text-white/60 font-secondary text-sm pr-14">
              ...
              <div className="flex gap-6">
                <div className="">
                  <button
                    className={`w-40 ${accentBgColor} hover:scale-110 transition text-black rounded-bl-xl rounded-tr-xl font-primary p-2 z-20 tracking-mini_stretch text-center`}
                  >
                    CONNECT
                  </button>
                </div>
              ...
              >
                {cards.slice(startIndex, startIndex + 3).map((card, index) => (
                  <div
                    ...
                    } duration-1000 rounded-2xl w-1/3 h-60 ${
                      card.imageUrl
